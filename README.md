...
A curated collection of links, tools, and references worth bookmarking - from dev workflow essentials to AI tools, design resources, and things that are just plain fun.
...
- [Engineering Workflow](#engineering-workflow)
  ...
  - [README.md](#readmemd)
- [Security](#security)
  - [Vulnerability Knowledge Bases](#vulnerability-knowledge-bases)
...
- [Learning & Reference](#learning--reference)
  - [Developer Quick References](#developer-quick-references)
  - [Roadmaps](#roadmaps)
  - [APIs](#apis)
  - [Projects](#projects)
- [AI](#ai)
  ...
  - [AI Tools](#ai-tools)
- [Design & UI](#design--ui)
  - [UI/UX Generators](#uiux-generators)
...
- [Material Design Color System](https://m2.material.io/design/color/the-color-system.html#tools-for-picking-colors) - Google's guidance on choosing and applying colour.
...
- **[Incredibox](https://www.incredibox.com)** - Create music mixes using animated beat-box characters - fun and oddly satisfying.
